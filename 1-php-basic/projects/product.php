                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                        ...
                                        <div class=" flex gap-2">
                                            <?php for ($i = 1; $i <= 5; $i++) : ?>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 <?= $i <= $obj->product_rating ? 
                                                'fill-yellow-500' : 'fill-gray-300' ?> ">
