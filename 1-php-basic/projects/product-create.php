    ...
    <form action="./product-save.php" method="post" enctype="multipart/form-data">
        ...
        <div class=" mb-5">
            ...
            <div class="relative ">
                ...
                <select required name="product_rating" data-hs-select='{
        ...
        <div class="flex justify-end">
            <button class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 active:scale-95">
                Save Product
            </button>
        </div>
    </form>
