...
<section class=" bg-gray-100 p-10 rounded-lg">
    ...
    <section>
        ...
        while (!feof($fileStream)) :
            ...
            if ($content === "\n") continue;
        ?>
            <p class=" font-mono bg-white text-gray-700 p-4 rounded-md mb-2">
                <?= $content ?>
            </p>
        ...
        <div class=" grid  grid-cols-2 gap-5">
            <a href="./index.php" class=" col-span-1 mt-4 w-full justify-center py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                Calculate Again
            </a>
            <a href="./exchange.php" class=" col-span-1 mt-4 w-full justify-center py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                Exchange Again
            </a>
        </div>
